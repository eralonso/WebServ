...
function getBody()
{
	...
	{
		evalBody += "<form method=\"POST\" action=\"loginAction.js\" style=\"display: flex; flex-direction: column; max-width:20em; margin: auto; padding: 1em; border: solid black 1px\">\r\n";
