...
def getBody():
	...
	if (userCookie != "" ):
		...
		evalBody += "<form method=\"POST\" action=\"/cgi_src/deepth/more_deepth/loginAction.py\" style=\"display: flex; flex-direction: column; max-width:20em; margin: auto; padding: 1em; border: solid black 1px\">\r\n"
